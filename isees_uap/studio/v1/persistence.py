...
class AuthoritativeStudioV1Store(Protocol):
    ...
    def list_artifacts(self, owner_id: str, investigation_id: str) -> Sequence[ArtifactIdentity]: ...
    ...
    def get_projection_output(self, owner_id: str, investigation_id: str, artifact_id: str, revision_id: str, projection_id: str) -> ExportRecord: ...
    def register_manifold_materialization(self, projection_id: str, export_id: str, configuration_identity: str, configuration_version: str) -> None: ...
