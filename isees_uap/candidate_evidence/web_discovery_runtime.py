    ...
    def _response(request, outcome) -> WebDiscoverySearchResponse:
        ...
        return WebDiscoverySearchResponse.model_validate({
            ...
            "receipt": {
                ...
                "providerCreditsConsumed": receipt.provider_credits_consumed,
                "providerCreditUsage": receipt.provider_credit_usage.value,
                "monetaryCost": receipt.monetary_cost,
                "researcherCharge": receipt.researcher_charge,
                "billingTriggered": receipt.billing_triggered,
