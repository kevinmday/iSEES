...
| SC-030 Investigation Library Mode and Overview Responsibility Architecture | SC-003; SC-009; SC-010; SC-012; SC-019; SC-021; SC-027; P57-UI-A20; P57-UI-A21; Canonical Investigation Architecture | Workspace Runtime; Overview and Library surfaces; investigation activation and continuity; Guide definitions; System Canon and repository projections; mode persistence and compatibility | OVERVIEW orientation; LIBRARY preview, selection, case management, and single governed intake; atomic activation to MANIFOLD; guest/account continuity; featured-event authority and presentation boundaries; domain-independent product identity |
