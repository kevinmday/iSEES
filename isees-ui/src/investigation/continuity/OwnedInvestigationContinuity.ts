...
type AdoptedOperational = Readonly<{ kind: "ADOPTED"; workspaceId: string; schemaVersion: "guest-investigation-adoption/v1"; source: Readonly<{ kind: "GUEST_SESSION"; guestInvestigationId: string; snapshotCreatedAt: string; snapshotUpdatedAt: string }>; title: string; objective: string | null; workspace: Readonly<{ sourceWorkspaceId: string; nodes: readonly Node[]; edges: readonly Edge[] }>; researchInbox: readonly Inbox[]; artifacts: readonly AdoptedArtifact[]; viewState: View }>;
