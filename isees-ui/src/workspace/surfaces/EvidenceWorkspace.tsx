...
export default function EvidenceWorkspace() {
  ...
  const webDiscoveryScope = operator.identity?.kind === "ACCOUNT" ? apiScope : undefined;
    ...
    <main className="evidence-workspace">
      ...
      {lane !== "INVESTIGATION" ? (() => {
        ...
        return <>
          ...
          {lane === "CANDIDATE" && <WebDiscoveryWorkspace authenticated={operator.identity?.kind === "ACCOUNT"} scope={webDiscoveryScope} binding={candidateBinding} onCandidateCaptured={refreshCapturedCandidate}/>}
