...
export default function IntentionWorkspace() {
  const { state, selectNode, selectLink, selectDerivation } = useIntentionWorkspace();
  ...
  return <main className="intention-workspace-shell">
    ...
    <IntentionProjectionViewport projection={state.projection} onProjectedNodeSelect={selectNode} onProjectedLinkSelect={selectLink} onMetricDerivationSelect={selectDerivation} />
  </main>;
}
