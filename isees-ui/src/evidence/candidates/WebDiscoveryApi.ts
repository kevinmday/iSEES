...
export interface WebDiscoverySearchCommand {
  ...
  readonly selectedObjectContext?: WebDiscoverySelectedObjectContext | null; readonly resultLimit: number;
  readonly idempotencyKey: string; readonly executionPolicy: WebDiscoveryExecutionPolicy;
}
...
export interface WebDiscoverySearchResponse {
  ...
  readonly normalizedQuery: string; readonly queryNormalizationVersion: string; readonly runtimeStatus: "LIVE_WEB_DISCOVERY" | "OFFLINE_FIXTURE" | "UNAVAILABLE"; readonly adapterId: string; readonly adapterVersion: string;
...
export interface WebDiscoveryCaptureCommand {
  ...
  readonly idempotencyKey: string; readonly researcherConfirmation: true; readonly addToResearchInbox: boolean; readonly researcherNote?: string | null;
}
...
export interface WebDiscoveryCaptureReceipt {
  ...
  readonly rexExecution: "NONE"; readonly estimatedProviderCost: 0; readonly actualProviderCost: 0; readonly finalCharge: 0;
  readonly researchInboxEffect: "NONE" | "CREATED" | "REPLAYED"; readonly publicationEffect: "NONE"; readonly candidateKnowledgeEffect: "NONE";
  readonly canonEffect: "NONE"; readonly graphEffect: "NONE"; readonly manifoldEffect: "NONE"; readonly resolveEffect: "NONE";
}
...
interface WebDiscoveryCaptureResponseBase {
  ...
  readonly researchInboxEffect: "NONE" | "CREATED" | "REPLAYED"; readonly researchInboxAnchorId: string | null;
...
const runtimeStatus = (value: unknown): WebDiscoverySearchResponse["runtimeStatus"] => ["LIVE_WEB_DISCOVERY", "OFFLINE_FIXTURE", "UNAVAILABLE"].includes(String(value)) ? value as WebDiscoverySearchResponse["runtimeStatus"] : (() => { throw new TypeError("runtimeStatus is invalid."); })();
