import type { ArtifactIdentity, AuthorRevision, FrozenResearchSourceSnapshot, PROJECTION_FORMATS, PROJECTION_STATES, SemanticDocument } from "../../contracts/StudioV1Contract.ts";

export type StudioV1AuthorOperation = "createArtifact" | "saveRevision" | "discoverArtifacts" | "getArtifact" | "listRevisions" | "getRevision" | "getSourceSnapshot" | "listProjectionStatuses" | "createExport" | "getExport" | "downloadExport" | "exportCurrentDraftPdf";
