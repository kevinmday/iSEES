...
export const STUDIO_ARTIFACT_DESIGNS: readonly StudioArtifactDesignDefinition[] = Object.freeze([
  ...
  { designId: "MANIFOLD_ARTIFACT", designVersion: "1", label: "Manifold Artifact", purpose: "Create a machine-readable projection for event-space expansion from the selected governed context. This is not a prose report and is not automatically admitted to the Manifold.", sectionPlan: ["Exact context manifest", "Source provenance", "Researcher declarations", "Unresolved questions", "Candidate research vectors"], draftingGuidance: "Project the captured context deterministically without prose generation or source inference.", provenanceExpectations: "Preserve exact source identities, provenance, document identity and revision, selected notes, exclusions, and the deterministic context hash." },
]);
